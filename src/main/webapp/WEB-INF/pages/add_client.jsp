...
<div align="center">
        <sf:form modelAttribute="clientBean"  method="POST"  action="/admin/client/add" name="add_form" onsubmit="return isNumber()">
            <table class="table table-bordered table-condensed"  style="width: auto;" >
            <thead>
                <tr>
                    <td colspan="2" align="center" style="font-size: 30px;">
                        <b>Добавить абонента</b>
                    </td>
                </tr>
                </thead>
            <tr>
                ...
                <td style="border-left: 0;padding: 8px;">
                    <sf:input   class="form-control" placeholder="Введите номер(0-авто)"  required="required"  id="cl_id" path="client_ID" cssStyle="height: 30px;"  />
            ...
            <tr>
                ...
                <td style="border-left: 0;padding: 8px;">
                    ...
                    <input class="form-control" placeholder="Введите адрес"  required="required"  id="address"  value="${con_req_address}"   style="height: 30px;" />
            ...
            <thead>
                <tr>
                    <td colspan="2" align="center" style="font-size: 30px;">
                        ...
                        <input type="hidden" name="id_con_req" value="${id_con_req}"/>
                        <input class="btn btn-lg  btn-primary btn-block " name="submit" type="submit" value="Добавить" />
                    </td>
                </tr>
                </thead>
        </table>
